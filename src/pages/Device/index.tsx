  ...
  return (
    <div className={styles.headerContent}>
      <div className={styles.content}>
        ...
        <div>
          <Button type="primary" shape="circle" icon={<PoweroffOutlined />} />
          <p>雷达重启</p>
        </div>
      </div>
        ...
        <ProCard split="vertical">
          <ProCard>
            ...
            <ProFormGroup label="雷达位姿">
              ...
              <ProFormText
                ...
                help="单位：°，格式 dd.ddddd°"
              />
              <ProFormText name="height" width={'sm'} label="雷达位置高度" help="单位：米" />
              <ProFormText
                name="zero_point"
                width={'sm'}
                label="雷达零点朝向"
          ...
          <ProCard>
            <ProFormGroup label="雷达天线">
              <ProFormText name="pitch" label="天线俯仰角" width={'sm'} help="单位：°" />
            </ProFormGroup>
            <ProFormGroup label="扫描区域">
              ...
              <ProFormText
                ...
                help="格式 dd.dd°,从转台零位开始，顺时针方向"
              />
              <ProFormText name="min_detect" label="最近探测距离" width={'sm'} help="单位：米" />
              <ProFormText name="max_detect" label="最远探测距离" width={'sm'} help="单位：米" />
            </ProFormGroup>
          </ProCard>
          <ProCard>
